...
function get_params(Ub,fb,ωb,Sb,Vb)
    ...
    return get_params(ωb, lg, rg, p_ref, q_ref, v_ref, ω_ref, vl, pl, lf, cf, rf, ωz, rt, lt, Dp,
    Dq, kip, kii, kffi, kvp, kvi, kffv, rv, lv, leq, req, vb, vdc_ref, cdc, kivb, kpvb, kpib, kiib, Ts)
end
