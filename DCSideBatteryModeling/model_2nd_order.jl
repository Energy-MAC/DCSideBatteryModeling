...
function dae_model_2nd_order(::Nothing)
    ...
    states = MTK.@variables begin
        ...
        D(t)      #Second term for 3rd-order Pade approx.
        E(t)      #Third term for 3rd-order Pade approx
        d_dc(t)   #DC/DC converter duty cycle
        i_in(t)   #Current flowing into the DC-link capacitor
        v_conv(t) #Magnitude of VSC AC terminal voltage
    end
    ...
    variables = MTK.@variables begin
        ...
        η      #Integrator term for outer DC/DC PI controller
        κ      #Integrator term for inner DC/DC PI controller
        A      #First term for 2nd-order Pade approx
        B      #Second term for 2nd-order Pade approx
        C      #First term for 3rd-order Pade approx
        D      #Second term for 3rd-order Pade approx
        E      #Third term for 3rd-order Pade approx
        d_dc   #DC/DC converter duty cycle
        i_in   #Current flowing into DC-link capacitor
        v_conv #VSC AC terminal voltage 
    end
